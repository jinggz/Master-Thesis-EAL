...
train_file = Path.joinpath(dir, 'trained', 'cleaned_obj.tsv')
test_file = Path.joinpath(dir, 'trained', 'cleaned_both_obj.tsv')
...
# Save model
MODEL_FILE = Path.joinpath(dir, 'model', 'malstm_obj_0621.h5')
